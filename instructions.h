...
enum InstructionsOpcode{
  ...
  lrem = 0x71, frem = 0x72, drem = 0x73, ineg = 0x74, lneg = 0x75, fneg = 0x76, dneg = 0x77, ishl = 0x78, lshl = 0x79, ishr = 0x7a,
  ...
  invokeinterface = 0xb9, invokedynamic = 0xba,inst_new = 0xbb, newarray = 0xbc, anewarray = 0xbd, arraylength = 0xbe, athrow = 0xbf, checkcast = 0xc0,
