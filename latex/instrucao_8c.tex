...
\item 
int \hyperlink{instrucao_8c_aaebdb63984789b9347c56a436e6a2ef4}{resolve\+U\+TF} (\hyperlink{structCpInfo}{Cp\+Info} $\ast$cp, int pos\+Pool)
\item 
...
\hyperlink{structVector}{Vector} $\ast$ {\bfseries array\+Vetores} = N\+U\+LL
\item 
...
\index{instrucao.\+c@{instrucao.\+c}!resolve\+U\+TF@{resolve\+U\+TF}}
\index{resolve\+U\+TF@{resolve\+U\+TF}!instrucao.\+c@{instrucao.\+c}}
\subsubsection{\texorpdfstring{resolve\+U\+T\+F()}{resolveUTF()}}
{\footnotesize\ttfamily int resolve\+U\+TF (\begin{DoxyParamCaption}\item[{\hyperlink{structCpInfo}{Cp\+Info} $\ast$}]{cp,  }\item[{int}]{pos\+Pool }\end{DoxyParamCaption})}
